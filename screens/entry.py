...
class Entry (Screen):
	...
	def showMenu (self):
		...
		self.buttonProduct.configure(command= self.btnMenuProducts)
		# add button employee
	...
	def inicialize(self, master):
		...
		self.LabelProduct.place(relx=0.15, rely=0.0, height=40, width=771)
		...
		self.LabelProductPrice.place(relx=0.498, rely=0.57, height=32, width=345)
		...
		self.LabelSummary.place(relx=0.15, rely=0.0, height=41, width=417)
		...
		self.LabelEmployee.place(relx=0.15, rely=0.0, height=43, width=771)
		...
		self.ButtonLoginEmployee = tk.Button(self.FrameEmployee)
		self.ButtonLoginEmployee.place(relx=0.5, rely=0.691, height=44
			, width=100)
		self.ButtonLoginEmployee.configure(activebackground="#ececec")
		self.ButtonLoginEmployee.configure(activeforeground="#000000")
		self.ButtonLoginEmployee.configure(background="#5ebaff")
		self.ButtonLoginEmployee.configure(disabledforeground="#a3a3a3")
		self.ButtonLoginEmployee.configure(font="-family {Segoe UI} -size 16 -weight normal -slant roman -underline 0 -overstrike 0")
		self.ButtonLoginEmployee.configure(foreground="#000000")
		self.ButtonLoginEmployee.configure(highlightbackground="#d9d9d9")
		self.ButtonLoginEmployee.configure(highlightcolor="black")
		self.ButtonLoginEmployee.configure(pady="0")
		self.ButtonLoginEmployee.configure(relief="flat")
		self.ButtonLoginEmployee.configure(text='''Log in''')
		# self.ButtonLoginEmployee.configure()
		...
		self.LabelInputs.place(relx=0.15, rely=0.0, height=43, width=1191)
